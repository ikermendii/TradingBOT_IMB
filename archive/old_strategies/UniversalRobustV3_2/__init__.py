"""
UNIVERSAL ROBUST V3.2 - INTERMEDIATE BALANCE (8787% ROI Strategy)
================================================================

BASED ON: v3.0 (8787% ROI Strategy) with INTERMEDIATE risk management
...
v3.1 Results (2020-2025):
- ROI: +807.0%
- Annual Return: 44.8%
- Max Drawdown: -47.35% (better but still high)
- Sharpe: 1.08

v3.2 CHANGES (Intermediate Balance):
- Leverage: 5x → 4x (middle ground between v3.0 and v3.1)
- Risk per trade: 1.5% → 1.25% (middle ground)
- Expected: Max DD ~-53-55% (between v3.0 and v3.1)
- Expected: Annual Return ~50-52% (between v3.0 and v3.1)
...
class UniversalRobustV3_2(Strategy):
    def __init__(self):
        super().__init__()
        self.vars = {
            'entry_price': 0,
    ...
    def risk_percent(self):
        return 1.25  # v3.2: 1.25% (intermediate between v3.0 1.5% and v3.1 1.0%)

    @property
    def leverage(self):
        return 4  # v3.2: 4x (intermediate between v3.0 5x and v3.1 3x)
